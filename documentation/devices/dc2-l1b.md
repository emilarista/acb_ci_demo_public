...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.31/24 | 192.168.0.5 |
...
| --------- | --------------- | ------------ | --------- |
| DC2-L1 | Vlan4094 | 100.66.4.0 | Port-Channel4 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | MLAG_PEER_dc2-l1a_Ethernet4 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4 |
| Ethernet5 | MLAG_PEER_dc2-l1a_Ethernet5 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4 |
| Ethernet7 | dc2-server1_Ethernet2 | *trunk | *10,20,30 | *4092 | *- | 6 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SP1_Ethernet2 | routed | - | 100.66.1.7/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SP2_Ethernet2 | routed | - | 100.66.1.9/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_DC2-SP3_Ethernet2 | routed | - | 100.66.1.11/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | MLAG_PEER_dc2-l1a_Po4 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel6 | dc2-server1_TEST2 | switched | trunk | 10,20,30 | 4092 | - | - | - | 6 | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 100.66.2.12/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 100.66.3.11/32 |
...
| Vlan4093 |  default  |  100.66.5.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  100.66.4.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0000.0004.0002.00 |
| Type | level-2 |
| Router-ID | 100.66.2.12 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 100.66.2.12:10010 | 65000:10010 | - | - | learned |
| 20 | 100.66.2.12:20020 | 65000:20020 | - | - | learned |
| 30 | 100.66.2.12:30030 | 65000:30030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| C1_VRF1 | 100.66.2.12:10 | connected |
| C2_VRF1 | 100.66.2.12:20 | connected |
| C3_VRF1 | 100.66.2.12:30 | connected |

#### Router BGP Device Configuration

```eos
!
router bgp 65000.201
   router-id 100.66.2.12
   maximum-paths 4 ecmp 4
   no bgp default ipv4-unicast
   no bgp default ipv4-unicast
