...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.32/24 | 192.168.0.5 |
...
| --------- | --------------- | ------------ | --------- |
| DC2-L2 | Vlan4094 | 100.66.4.5 | Port-Channel4 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | MLAG_PEER_dc2-l2b_Ethernet4 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4 |
| Ethernet5 | MLAG_PEER_dc2-l2b_Ethernet5 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SP1_Ethernet3 | routed | - | 100.66.1.13/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SP2_Ethernet3 | routed | - | 100.66.1.15/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_DC2-SP3_Ethernet3 | routed | - | 100.66.1.17/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_DC2-SP3_Ethernet3
   no shutdown
   mtu 1500
   no switchport
   ip address 100.66.1.17/31
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
   isis network point-to-point
!
interface Ethernet4
   description MLAG_PEER_dc2-l2b_Ethernet4
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_PEER_dc2-l2b_Ethernet5
   no shutdown
   channel-group 4 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | MLAG_PEER_dc2-l2b_Po4 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel4
   description MLAG_PEER_dc2-l2b_Po4
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 100.66.2.13/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 100.66.3.13/32 |
...
| Vlan4093 |  default  |  100.66.5.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  100.66.4.4/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0000.0004.0003.00 |
| Type | level-2 |
| Router-ID | 100.66.2.13 |
...
!
router isis CORE
   net 49.0001.0000.0004.0003.00
   is-type level-2
   router-id ipv4 100.66.2.13
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 100.66.2.13:10010 | 65000:10010 | - | - | learned |
| 20 | 100.66.2.13:20020 | 65000:20020 | - | - | learned |
| 30 | 100.66.2.13:30030 | 65000:30030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| C1_VRF1 | 100.66.2.13:10 | connected |
| C2_VRF1 | 100.66.2.13:20 | connected |
| C3_VRF1 | 100.66.2.13:30 | connected |

#### Router BGP Device Configuration

```eos
!
router bgp 65000.202
   router-id 100.66.2.13
   maximum-paths 4 ecmp 4
   no bgp default ipv4-unicast
   no bgp default ipv4-unicast
   ...
   !
   vlan 10
      rd 100.66.2.13:10010
      route-target both 65000:10010
      redistribute learned
   !
   vlan 20
      rd 100.66.2.13:20020
      route-target both 65000:20020
      redistribute learned
   !
   vlan 30
      rd 100.66.2.13:30030
