...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.48/24 | 192.168.0.5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_s1-p3_Ethernet2 | routed | - | 100.65.1.29/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_s1-p4_Ethernet2 | routed | - | 100.65.1.37/31 | default | 1500 | False | - | - |
| Ethernet3 | INTERNET-ISP1 | routed | - | 172.31.0.3/31 | INTERNET | - | False | - | - |

##### IPv6

| Interface | Description | Type | Channel Group | IPv6 Address | VRF | MTU | Shutdown | ND RA Disabled | Managed Config Flag | IPv6 ACL In | IPv6 ACL Out |
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_LINK_TO_s1-p3_Ethernet2 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet2 | P2P_LINK_TO_s1-p4_Ethernet2 | routed | - | - | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_s1-p3_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 100.65.1.29/31
   ipv6 enable
   mpls ip
   isis enable CORE
...
!
interface Ethernet2
   description P2P_LINK_TO_s1-p4_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 100.65.1.37/31
   ipv6 enable
   mpls ip
   isis enable CORE
   isis circuit-type level-2
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 100.65.3.2/32 |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0000.0006.0002.00 |
| Type | level-2 |
| Router-ID | 100.65.3.2 |
...
!
router isis CORE
   net 49.0001.0000.0006.0002.00
   is-type level-2
   router-id ipv4 100.65.3.2
...
| --- | ------------------- | ------------ |
| INTERNET | 100.65.3.2:1 | connected |
...
router bgp 65001
   ...
   vrf INTERNET
      ...
      router-id 100.65.3.2
      update wait-install
      neighbor 172.31.0.2 remote-as 1234
      neighbor 172.31.0.2 local-as 808 no-prepend replace-as
      neighbor 172.31.0.2 description ISP
