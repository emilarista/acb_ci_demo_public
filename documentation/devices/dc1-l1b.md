...
| --------- | --------------- | ------------ | --------- |
| DC1-L1 | Vlan4094 | 100.64.4.0 | Port-Channel4 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | MLAG_PEER_dc1-l1a_Ethernet4 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4 |
| Ethernet5 | MLAG_PEER_dc1-l1a_Ethernet5 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4 |
| Ethernet7 | dc1-server1_Ethernet2 | *trunk | *10,20,30 | *4092 | *- | 6 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP1_Ethernet2 | routed | - | 100.64.1.7/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP2_Ethernet2 | routed | - | 100.64.1.9/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-SP3_Ethernet2 | routed | - | 100.64.1.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_DC1-SP3_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.1.11/31
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
   isis network point-to-point
!
interface Ethernet4
   description MLAG_PEER_dc1-l1a_Ethernet4
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_PEER_dc1-l1a_Ethernet5
   no shutdown
   channel-group 4 mode active
!
interface Ethernet7
   description dc1-server1_Ethernet2
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | MLAG_PEER_dc1-l1a_Po4 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel4
   description MLAG_PEER_dc1-l1a_Po4
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 100.64.2.12/32 |
...
| Vlan4093 |  default  |  100.64.5.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  100.64.4.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 100.64.2.12:10010 | 65000:10010 | - | - | learned |
| 20 | 100.64.2.12:20020 | 65000:20020 | - | - | learned |
| 30 | 100.64.2.12:30030 | 65000:30030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| C1_VRF1 | 100.64.2.12:10 | connected |
| C2_VRF1 | 100.64.2.12:20 | connected |
| C3_VRF1 | 100.64.2.12:30 | connected |
...
router bgp 65000.101
   ...
   !
   vlan 10
      rd 100.64.2.12:10010
      route-target both 65000:10010
      redistribute learned
   !
   vlan 20
      rd 100.64.2.12:20020
      route-target both 65000:20020
      redistribute learned
   !
   vlan 30
      rd 100.64.2.12:30030
