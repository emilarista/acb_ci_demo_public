...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.45/24 | 192.168.0.5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_dc1-el1_Ethernet5 | routed | - | 100.65.1.14/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_dc1-el2_Ethernet5 | routed | - | 100.65.1.16/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_dc1-el3_Ethernet5 | routed | - | 100.65.1.18/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_s1-p1_Ethernet4 | routed | - | 100.65.1.7/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_s1-p3_Ethernet6 | routed | - | 100.65.1.20/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_s1-p4_Ethernet5 | routed | - | 100.65.1.22/31 | default | 1500 | False | - | - |
| Ethernet7 | P2P_LINK_TO_s2-p2_Ethernet7 | *routed | 7 | *100.65.1.24/31 | **default | *1500 | *False | **- | **- |
| Ethernet8 | P2P_LINK_TO_s2-p2_Ethernet8 | *routed | 7 | *100.65.1.24/31 | **default | *1500 | *False | **- | **- |
*Inherited from Port-Channel Interface
...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet4 | P2P_LINK_TO_s1-p1_Ethernet4 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet5 | P2P_LINK_TO_s1-p3_Ethernet6 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet6 | P2P_LINK_TO_s1-p4_Ethernet5 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet7 | P2P_LINK_TO_s2-p2_Ethernet7 | *routed | 7 | *- | *default | *1500 | *False | *- | *- | *- | *- |
| Ethernet8 | P2P_LINK_TO_s2-p2_Ethernet8 | *routed | 7 | *- | *default | *1500 | *False | *- | *- | *- | *- |
 *Inherited from Port-Channel Interface
...
| --------- | ----------- | ---- | ------- | ---------- | --- | --- | -------- | ------ | ------- |
| Port-Channel7 | P2P_LINK_TO_s2-p2_Port-Channel7 | routed | - | 100.65.1.24/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 100.65.4.1/32 |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0000.0007.0001.00 |
| Type | level-2 |
