...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.19/24 | 192.168.0.5 |
...
| --------- | --------------- | ------------ | --------- |
| DC1-L3 | Vlan4094 | 100.64.4.8 | Port-Channel4 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | MLAG_PEER_dc1-l3a_Ethernet4 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4 |
| Ethernet5 | MLAG_PEER_dc1-l3a_Ethernet5 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP1_Ethernet6 | routed | - | 100.64.1.31/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP2_Ethernet6 | routed | - | 100.64.1.33/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-SP3_Ethernet6 | routed | - | 100.64.1.35/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_DC1-SP3_Ethernet6
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.1.35/31
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
   isis network point-to-point
!
interface Ethernet4
   description MLAG_PEER_dc1-l3a_Ethernet4
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_PEER_dc1-l3a_Ethernet5
   no shutdown
   channel-group 4 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | MLAG_PEER_dc1-l3a_Po4 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel4
   description MLAG_PEER_dc1-l3a_Po4
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 100.64.2.16/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 100.64.3.15/32 |
...
| Vlan4093 |  default  |  100.64.5.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  100.64.4.9/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0000.0002.0006.00 |
| Type | level-2 |
| Router-ID | 100.64.2.16 |
...
!
router isis CORE
   net 49.0001.0000.0002.0006.00
   is-type level-2
   router-id ipv4 100.64.2.16
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 100.64.2.16:10010 | 65000:10010 | - | - | learned |
| 20 | 100.64.2.16:20020 | 65000:20020 | - | - | learned |
| 30 | 100.64.2.16:30030 | 65000:30030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| C1_VRF1 | 100.64.2.16:10 | connected |
| C2_VRF1 | 100.64.2.16:20 | connected |
| C3_VRF1 | 100.64.2.16:30 | connected |

#### Router BGP Device Configuration

```eos
!
router bgp 65000.103
   router-id 100.64.2.16
   maximum-paths 4 ecmp 4
   no bgp default ipv4-unicast
   no bgp default ipv4-unicast
   ...
   !
   vlan 10
      rd 100.64.2.16:10010
      route-target both 65000:10010
      redistribute learned
   !
   vlan 20
      rd 100.64.2.16:20020
      route-target both 65000:20020
      redistribute learned
   !
   vlan 30
      rd 100.64.2.16:30030
