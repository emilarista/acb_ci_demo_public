...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.33/24 | 192.168.0.5 |
...
| --------- | --------------- | ------------ | --------- |
| DC2-L2 | Vlan4094 | 100.66.4.4 | Port-Channel4 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 | MLAG_PEER_dc2-l2a_Ethernet4 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4 |
| Ethernet5 | MLAG_PEER_dc2-l2a_Ethernet5 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SP1_Ethernet4 | routed | - | 100.66.1.19/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SP2_Ethernet4 | routed | - | 100.66.1.21/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_DC2-SP3_Ethernet4 | routed | - | 100.66.1.23/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_DC2-SP3_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ip address 100.66.1.23/31
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
   isis network point-to-point
!
interface Ethernet4
   description MLAG_PEER_dc2-l2a_Ethernet4
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description MLAG_PEER_dc2-l2a_Ethernet5
   no shutdown
   channel-group 4 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | MLAG_PEER_dc2-l2a_Po4 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel4
   description MLAG_PEER_dc2-l2a_Po4
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 100.66.2.14/32 |
...
| Vlan4093 |  default  |  100.66.5.5/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  100.66.4.5/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0000.0004.0004.00 |
| Type | level-2 |
| Router-ID | 100.66.2.14 |
...
!
router isis CORE
   net 49.0001.0000.0004.0004.00
   is-type level-2
   router-id ipv4 100.66.2.14
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 100.66.2.14:10010 | 65000:10010 | - | - | learned |
| 20 | 100.66.2.14:20020 | 65000:20020 | - | - | learned |
| 30 | 100.66.2.14:30030 | 65000:30030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| C1_VRF1 | 100.66.2.14:10 | connected |
| C2_VRF1 | 100.66.2.14:20 | connected |
| C3_VRF1 | 100.66.2.14:30 | connected |
...
router bgp 65000.202
   ...
   !
   vlan 10
      rd 100.66.2.14:10010
      route-target both 65000:10010
      redistribute learned
   !
   vlan 20
      rd 100.66.2.14:20020
      route-target both 65000:20020
      redistribute learned
   !
   vlan 30
      rd 100.66.2.14:30030
