...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP1_Ethernet12 | routed | - | 100.64.1.67/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP2_Ethernet12 | routed | - | 100.64.1.69/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-SP3_Ethernet12 | routed | - | 100.64.1.71/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_s1-p1_Ethernet2 | routed | - | 100.65.1.3/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_s1-p2_Ethernet2 | routed | - | 100.65.1.17/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-SP1_Ethernet12
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.1.67/31
   isis enable CORE
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SP2_Ethernet12
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.1.69/31
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
   isis network point-to-point
!
interface Ethernet3
   description P2P_LINK_TO_DC1-SP3_Ethernet12
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.1.71/31
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
   isis network point-to-point
!
interface Ethernet4
   description P2P_LINK_TO_s1-p1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 100.65.1.3/31
   mpls ip
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
...
!
interface Ethernet5
   description P2P_LINK_TO_s1-p2_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 100.65.1.17/31
   mpls ip
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 100.64.2.22/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 100.64.3.22/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 100.64.2.22/32
   isis enable CORE
   isis passive
   node-segment ipv4 index 512
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 100.64.3.22/32
   isis enable CORE
   isis passive
```
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0000.0002.0012.00 |
| Type | level-2 |
| Router-ID | 100.64.2.22 |
...
!
router isis CORE
   net 49.0001.0000.0002.0012.00
   is-type level-2
   router-id ipv4 100.64.2.22
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 100.64.2.22:10010 | 65000:10010 | - | - | learned |
| 20 | 100.64.2.22:20020 | 65000:20020 | - | - | learned |
| 30 | 100.64.2.22:30030 | 65000:30030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| C1_VRF1 | 100.64.2.22:10 | connected |
| C2_VRF1 | 100.64.2.22:20 | connected |
| C3_VRF1 | 100.64.2.22:30 | connected |
...
router bgp 65000.106
   ...
   !
   vlan 10
      rd 100.64.2.22:10010
      route-target both 65000:10010
      redistribute learned
   !
   vlan 20
      rd 100.64.2.22:20020
      route-target both 65000:20020
      redistribute learned
   !
   vlan 30
      rd 100.64.2.22:30030
