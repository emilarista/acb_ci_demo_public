...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.40/24 | 192.168.0.5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SP1_Ethernet11 | routed | - | 100.66.1.61/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SP2_Ethernet11 | routed | - | 100.66.1.63/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_DC2-SP3_Ethernet11 | routed | - | 100.66.1.65/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_s2-p1_Ethernet1 | routed | - | 100.65.1.41/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_s2-p2_Ethernet1 | routed | - | 100.65.1.53/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC2-SP1_Ethernet11
   no shutdown
   mtu 1500
   no switchport
   ip address 100.66.1.61/31
   isis enable CORE
...
!
interface Ethernet2
   description P2P_LINK_TO_DC2-SP2_Ethernet11
   no shutdown
   mtu 1500
   no switchport
   ip address 100.66.1.63/31
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
   isis network point-to-point
!
interface Ethernet3
   description P2P_LINK_TO_DC2-SP3_Ethernet11
   no shutdown
   mtu 1500
   no switchport
   ip address 100.66.1.65/31
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
   isis network point-to-point
!
interface Ethernet4
   description P2P_LINK_TO_s2-p1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.65.1.41/31
   mpls ip
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
...
!
interface Ethernet5
   description P2P_LINK_TO_s2-p2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 100.65.1.53/31
   mpls ip
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 100.66.2.21/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 100.66.3.21/32 |
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0000.0004.0011.00 |
| Type | level-2 |
| Router-ID | 100.66.2.21 |
...
!
router isis CORE
   net 49.0001.0000.0004.0011.00
   is-type level-2
   router-id ipv4 100.66.2.21
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 100.66.2.21:10010 | 65000:10010 | - | - | learned |
| 20 | 100.66.2.21:20020 | 65000:20020 | - | - | learned |
| 30 | 100.66.2.21:30030 | 65000:30030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| C1_VRF1 | 100.66.2.21:10 | connected |
| C2_VRF1 | 100.66.2.21:20 | connected |
| C3_VRF1 | 100.66.2.21:30 | connected |
...
router bgp 65000.206
   ...
   !
   vlan 10
      rd 100.66.2.21:10010
      route-target both 65000:10010
      redistribute learned
   !
   vlan 20
      rd 100.66.2.21:20020
      route-target both 65000:20020
      redistribute learned
   !
   vlan 30
      rd 100.66.2.21:30030
